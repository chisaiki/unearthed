//This file will create a gifts table and load the data we already 
//have into the database.
...
/**
 We already have the data we need the table to start with in our data/gifts.js file. 
 Let's send this data over to the database.
 */
